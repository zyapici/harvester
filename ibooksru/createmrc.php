...
$cmd="\"C:\Program Files\MarcEdit 6\cmarcedit.exe\" -utf8 -make -s \"c:\wamp64\www\\ibooksru\\".$custid."\mrk\\".$publisher.".mrk\" -d \"c:\wamp64\www\\ibooksru\\".$custid."\marc\\".$publisher."_".date('dmY').".mrc\"";

			    ...
			    while (($line = fgets($handle)) !== false) {
			        ...
			        print("<tr onmouseover=\"this.style.backgroundColor='#ffff66'\" onmouseout=\"this.style.backgroundColor='#d4e3e5'\">
			                 ...
			                 <td>$column[4]</td>
                                         <td>$column[1]</td>
			                 <td>
                                             <a href='details.php?file=mrk&custid=$column[0]'>
                                                 <img src=images/database.jpg width='40px' height='40px'/>
                                             </a>
                                             <a class='deletedatamrk' onclick='return command(\"delete.php?file=mrk&custid=$column[0]\")' href='#'>
                                                 <img src=images/delete.png width='40px' height='40px'/>
                                             </a>
                                             <a href='details.php?file=marc&custid=$column[0]'>
                                                 <img src=images/database.jpg width='40px' height='40px'/>
                                             </a>
                                             <a class='deletedatamarc' onclick='return command(\"delete.php?file=marc&custid=$column[0]\")' href='#'>
                                                 <img src=images/delete.png width='40px' height='40px'/>
                                             </a>
                                         </td>");
			                 ...
			                 print("
			                 <td>
                                         <a class='getrecords' onclick='return command(\"ibooks_api.php?customerId=$column[1]&custid=$column[0]\")' href='#'>
                                              <img src=images/download.png width='80px' height='40px'/>
                                         </a>
                                         <a class='createubomrc' target='_blank' onclick='return command(\"createmrc.php?publisher=ibooksru&custid=$column[0]\")' href='#'>
...
//////////////////////////END_LOAD_PAGE/////////////////////////
    ...
    var deletedatamrkarray = document.getElementsByClassName('deletedatamrk');
    var deletedatamarcarray = document.getElementsByClassName('deletedatamarc');
     ...
     for (i = 0; i < statusarray.length; i++) 
     {
      ...
      days = Math.round(Math.abs(diffc/(1000*60*60*24)));
          ...
          if(days > updateinterval)
          {
              ...
              {
                  deletedatamrkarray[i].click();
              }
              if(stat.indexOf('mrk files were deleted.')>-1) 
              {
                  deletedatamarcarray[i].click();
              }

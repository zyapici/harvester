...
$cmd="\"C:\Program Files\MarcEdit 6\cmarcedit.exe\" -utf8 -make -s \"c:\wamp64\www\\edsulo\\".$custid."\mrk\\".$publisher.".mrk\" -d \"c:\wamp64\www\\edsulo\\".$custid."\marc\\".$publisher."_".date('dmY').".mrc\"";

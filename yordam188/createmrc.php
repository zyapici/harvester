...
$cmd="\"C:\Program Files\MarcEdit 6\cmarcedit.exe\" -utf8 -make -s \"c:\wamp64\www\yordam188\\".$custid."\marc\allmark(records).mrk\" -d \"c:\wamp64\www\yordam188\\".$custid."\marc\allmark(records).mrc\"";
shell_exec($cmd);

			...
			if ($handle) {
			    while (($line = fgets($handle)) !== false) {
			    	$column = explode(";", $line);
                                ...
                                {
                                    $myDirectory = opendir($column[0]."/xml/");
									$dirArray=array();
                                    ...
                                    if(($indexCount*20)>=NumberofRecordILS($column[0]))
                                    {
			        ...
			        print("<tr onmouseover=\"this.style.backgroundColor='#ffff66'\" onmouseout=\"this.style.backgroundColor='#d4e3e5'\">
			                 ...
			                 <td>
                                         <a href='details.php?file=xml&custid=$column[0]'>
                                                 <img src=images/xml.png width='40px' height='40px'/>
                                         </a>
                                         <a class='deletexml' onclick='return command(\"delete.php?file=XML&custid=$column[0]\")' href='#'>
                                                 <img src=images/delete.png width='40px' height='40px'/>
                                         </a>
                                         </td>");
...
//////////////////////////END_LOAD_PAGE/////////////////////////
    ...
    var deletexmlarray = document.getElementsByClassName('deletexml');
     ...
     for (i = 0; i < statusarray.length; i++) 
     {
      ...
      days = Math.round(Math.abs(diffc/(1000*60*60*24)));
          ...
          if(days > updateinterval)
          {
              ...
              {
                  deletexmlarray[i].click();
              }
              if(stat.indexOf('XML files were deleted.')>-1 && today.getHours()>13 && today.getHours()<21) 
              {

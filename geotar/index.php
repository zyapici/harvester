			...
			if ($handle) {
			    while (($line = fgets($handle)) !== false) {
			        ...
			        print("<tr onmouseover=\"this.style.backgroundColor='#ffff66'\" onmouseout=\"this.style.backgroundColor='#d4e3e5'\">
			                 ...
			                 print("
			                 <td>
                                         <a class='getgeotarrecords' onclick='return command(\"geotar/getGeotarRecords.php?collectionId=$column[5]&custid=$column[0]\")' href='#'>
...
//////////////////////////END_LOAD_PAGE/////////////////////////
    ...
    var getrecordsarray = document.getElementsByClassName('getgeotarrecords');
